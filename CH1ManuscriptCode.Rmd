---
title: "RevisedTXManuscript_Code"
author: "Ana Silverio"
date: "2025-03-07"
output:
...
#color palette
colorBlindBlack8 <- c("#001219","#005f73",  "#0a9396","#94d2bd", "#ee9b00", "#bb3e03","#ca6702","#ae2012")
...
#redDrum_mon_avg <- bag.seines %>% #testing something here, can delete later
 # group_by(MONTH,YEAR,MAJOR_AREA_CODE) %>%
 # summarize(mean(rd_CPUE), count = n())
...
time_series <- ggarrange(rd + rremove("ylab") + rremove("xlab"), sst +rremove("ylab") + rremove("xlab"), bd+rremove("ylab") + rremove("xlab"), sf+rremove("ylab") + rremove("xlab"), labels = NULL, common.legend = TRUE,ncol = 2, nrow = 2, legend = "right", font.label = list(size = 13, face = "bold"))

#time_series

annotate_figure(time_series,
                bottom = text_grob("Time", size = 19, hjust = 1),
                left = text_grob("CPUE (#/hectare)", rot = 90, size = 18))


#annotate_figure(aransas_gn_plot, top = text_grob("Aransas Bay Gill Nets and Winter Storm Uri", color = "#8B0000", face = "bold", size = 14))

#ggsave("Figure2_revisedManuscript.jpg", width = 10, height = 8, units = c("in"), dpi = 300, bg = "white")
